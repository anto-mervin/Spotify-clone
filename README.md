...
1. **Music Playback** - `AudioPlayer.jsx`, `MusicPlayer.jsx`: Provides audio playback controls for the track.
2. **Music Search** - `MusicSearch.jsx`: Allows users to search for songs or artists.
3. **Music List** - `MusicStack.jsx`: Displays a stack of songs for the playlist.
...
6. **Spotify-Like Sidebar** - `SpotifySideBar.jsx`: Sidebar according to Figma UI design.
7. **Home Page** - `Home.jsx`: Main page that integrates all core app components.
...
11. **Dynamic Background** - Changes background color according to the cover image.
